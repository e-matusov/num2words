...
class LanguageResources_UK:
    ...
    def __init__(self):
        ...
        self.CURRENCY_FORMS = {
            ...
            'GBP': (
                (('фунт', 'фунта', 'фунта', 'фунту', 'фунтові', 'фунт', 'фунт', 'фунтом', 'фунтом', 'фунті', 'фунті'),
                 ('фунта', 'фунтів', 'фунтів', 'фунтам', 'фунтам', 'фунта', 'фунта', 'фунтами', 'фунтами', 'фунтах', 'фунтах'),
                 ('фунтів', 'фунтів', 'фунтів', 'фунтам', 'фунтам', 'фунтів', 'фунтів', 'фунтами', 'фунтами', 'фунтах', 'фунтах')),
                (('пенс', 'пенса', 'пенса', 'пенсу', 'пенсові', 'пенс', 'пенс', 'пенсом', 'пенсом', 'пенсі', 'пенсі'),
                 ('пенсі', 'пенса', 'пенсі', 'пенсам', 'пенсам', 'пенсі', 'пенса', 'пенсами', 'пенсами', 'пенсах', 'пенсі'),
                 ('пенсів', 'пенсів', 'пенсів', 'пенсам', 'пенсам', 'пенсі', 'пенси', 'пенсами', 'пенсами', 'пенсах', 'пенсі')),
            ),
            'UAH': (
